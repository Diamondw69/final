...
// 	protoc        v4.23.0
// source: pkg/inventory/proto/inventory.proto
...
func (x *CaseItem) Reset() {
	*x = CaseItem{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_inventory_proto_inventory_proto_msgTypes[0]
...
func (*CaseItem) Descriptor() ([]byte, []int) {
	return file_pkg_inventory_proto_inventory_proto_rawDescGZIP(), []int{0}
}
...
func (x *Inventory) Reset() {
	*x = Inventory{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_inventory_proto_inventory_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Inventory) Descriptor() ([]byte, []int) {
	return file_pkg_inventory_proto_inventory_proto_rawDescGZIP(), []int{1}
}
...
func (x *Confirm) Reset() {
	*x = Confirm{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_inventory_proto_inventory_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Confirm) Descriptor() ([]byte, []int) {
	return file_pkg_inventory_proto_inventory_proto_rawDescGZIP(), []int{2}
}
...
func (x *InventoryRequest) Reset() {
	*x = InventoryRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_inventory_proto_inventory_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InventoryRequest) Descriptor() ([]byte, []int) {
	return file_pkg_inventory_proto_inventory_proto_rawDescGZIP(), []int{3}
}
...
var File_pkg_inventory_proto_inventory_proto protoreflect.FileDescriptor

var file_pkg_inventory_proto_inventory_proto_rawDesc = []byte{
	0x0a, 0x23, 0x70, 0x6b, 0x67, 0x2f, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2e,
	...
	0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x2e,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pkg_inventory_proto_inventory_proto_rawDescOnce sync.Once
	file_pkg_inventory_proto_inventory_proto_rawDescData = file_pkg_inventory_proto_inventory_proto_rawDesc
)

func file_pkg_inventory_proto_inventory_proto_rawDescGZIP() []byte {
	file_pkg_inventory_proto_inventory_proto_rawDescOnce.Do(func() {
		file_pkg_inventory_proto_inventory_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_inventory_proto_inventory_proto_rawDescData)
	})
	return file_pkg_inventory_proto_inventory_proto_rawDescData
}

var file_pkg_inventory_proto_inventory_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_inventory_proto_inventory_proto_goTypes = []interface{}{
...
var file_pkg_inventory_proto_inventory_proto_depIdxs = []int32{
...
func init() { file_pkg_inventory_proto_inventory_proto_init() }
func file_pkg_inventory_proto_inventory_proto_init() {
	if File_pkg_inventory_proto_inventory_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_inventory_proto_inventory_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_inventory_proto_inventory_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_inventory_proto_inventory_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_inventory_proto_inventory_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_inventory_proto_inventory_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_inventory_proto_inventory_proto_goTypes,
		DependencyIndexes: file_pkg_inventory_proto_inventory_proto_depIdxs,
		MessageInfos:      file_pkg_inventory_proto_inventory_proto_msgTypes,
	}.Build()
	File_pkg_inventory_proto_inventory_proto = out.File
	file_pkg_inventory_proto_inventory_proto_rawDesc = nil
	file_pkg_inventory_proto_inventory_proto_goTypes = nil
	file_pkg_inventory_proto_inventory_proto_depIdxs = nil
}
